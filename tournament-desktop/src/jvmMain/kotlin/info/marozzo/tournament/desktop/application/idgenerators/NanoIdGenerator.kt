...
class NanoIdGenerator(
    ...
    private val random: RandomByteGenerator = defaultRandomByteGenerator,
    private val alphabet: CharArray = defaultAlphabet
) : IdGenerator<NonEmptyList<NanoIdError>, NanoId> {
    override fun generate(): Either<NonEmptyList<NanoIdError>, NanoId> = either {
        zipOrAccumulate(
